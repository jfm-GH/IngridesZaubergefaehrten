<template>
    <div class="gallery-item" >
      ...
      <canvas v-if="!imageLoaded" ref="blurhashCanvas" class="img-fluid"></canvas>
      -->
  ...
  export default {
    ...
    methods: {
      displayBlurHash() {
        //const image = decode(this.blurHash, 32, 32); // Adjust dimensions as needed
        ...
        //const image = ctx.createImageData(32, 32); // Adjust dimensions as needed
